...
## 本项目获取地址：https://www.bishecode.com/product/225/
...
图5.2 捐赠信息管理页面【如图5.2显示的就是捐赠信息管理页面，此页面提供给管理员的功能有：查看已发布的捐赠信息数据，修改捐赠信息，捐赠信息作废，即可删除，还进行了对捐赠信息名称的模糊查询 捐赠信息信息的类型查询等等一些条件。】
